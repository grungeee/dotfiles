...
# Only add archlinux plugin if not on macOS
...
alias nvt="nvim +terminal +startinsert"
alias acli="arduino-cli"
alias quicknotes="cd ~/Documents/Notes/quicknotes/"


# |============< PERSONAL >================|
# |________________________________________|
# |____________| grungeee |________________|
# |----------------------------------------|
...
# |----------------------------------------|
  ...
  [[ ! -f ~/.p10k.zsh ]] || source ~/.zshrc-personal #!exist ? do nothing : source
...
export PATH="/Users/grungeee/.local/bin:$PATH"
